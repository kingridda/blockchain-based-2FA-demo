...
RUN cd adamant-console && sed 's/"passPhrase": ""/"passPhrase": "talent check egg grief fade guard admit imitate album smile punch hazard"/' temp.json > config.default.json
